package com.example.experimentsix;
...
public class MainActivity extends AppCompatActivity {
    public static String file="C:\\Users\\Deept\\Desktop\\details.txt";
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    for(String record:file_read){
                        ...
                        if(details[0].equalsIgnoreCase(username_) && details[1].equalsIgnoreCase(password_)){
                            isFound=true;
                            break;
                        }
                    }
